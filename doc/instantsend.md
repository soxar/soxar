...
This mechanism has been integrated into Bitcore-Node-Soxar which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/soxarpay/insight-api-soxar#web-socket-api](https://github.com/soxarpay/insight-api-soxar#web-socket-api)
* API: [https://github.com/soxarpay/insight-api-soxar#instantsend-transactions](https://github.com/soxarpay/insight-api-soxar#instantsend-transactions)
...
By default, the Soxar Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Soxar Core daemon:
