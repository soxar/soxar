...
This document provides guidelines for internationalization of the Soxar Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `soxar_en.ts` remains unchanged.
