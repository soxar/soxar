...
//! These need to be macros, as clientversion.cpp's and soxar*-res.rc's voodoo requires it
...
/**
 * soxard-res.rc includes this file, but it cannot cope with real c++ code.
