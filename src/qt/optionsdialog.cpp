    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("XAR-light"), QVariant("light"));
    ui->theme->addItem(QString("XAR-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("XAR-light-retro"), QVariant("light-retro"));
    ui->theme->addItem(QString("XAR-light-hires-retro"), QVariant("light-hires-retro"));
    ui->theme->addItem(QString("XAR-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("XAR-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("XAR-traditional"), QVariant("trad"));
