    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = tr("Usage:") + "\n" +
            "  soxar-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Soxar in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 XAR, 0.1 XAR, 1 XAR and 10 XAR -- sort of like the paper money you use every day.</li> \
