...
UniValue masternodelist(const JSONRPCRequest& request)
{
                ...
                strMode != "rank" && strMode != "sentinel" && strMode != "status"))
    {
        throw std::runtime_error(
                ...
                "  payee          - Print Soxar address associated with a masternode (can be additionally filtered,\n"
                "                   partial match)\n"
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "soxar",               "masternode",             &masternode,             true,  {} },
    { "soxar",               "masternodelist",         &masternodelist,         true,  {} },
    { "soxar",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "soxar",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "soxar",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "soxar",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
